---
lab:
  title: Desarrollo de una solución multiagente con Microsoft Foundry
  description: Aprenda a configurar varios agentes para que colaboren con Microsoft Foundry Agent Service.
---

# Desarrollo de una solución de varios agentes

En este ejercicio, creará un proyecto que orquesta varios agentes de IA mediante Microsoft Foundry Agent Service. Diseñarás una solución de IA que ayude con la evaluación de prioridades de incidencias. Los agentes conectados evaluarán la prioridad de la incidencia, sugerirán la asignación de un equipo y determinarán el nivel de esfuerzo necesario para completar la incidencia. Comencemos.
