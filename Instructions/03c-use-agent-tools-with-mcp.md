...
## Creación de un proyecto de Microsoft Foundry
...
1. Copie el valor del **punto de conexión del proyecto de Foundry**. Lo usará para conectarse al proyecto en una aplicación cliente.
