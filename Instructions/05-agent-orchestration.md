...
## Implementación de un modelo en un proyecto de Microsoft Foundry

Comencemos implementando un modelo en un proyecto de Foundry.
...
1. En el panel de navegación de la izquierda, selecciona **Información general** para ver la página principal del proyecto; que tiene este aspecto:
    ...
    ![Recorte de pantalla de los detalles de un proyecto de Azure AI en el portal de Foundry.](./Media/ai-foundry-project.png)
...
1. En el archivo de código, reemplace el marcador de posición **your_openai_endpoint** por el punto de conexión del proyecto (copiado de la página **Información general** del proyecto en el portal de Foundry). Reemplace el marcador de posición **your_model_deployment** por el nombre que asignó a la implementación del modelo gpt-4o.
...
1. Agregue el código siguiente en el comentario **Crear el cliente de chat**:
   ...
   async with (
    ...
    Tenga en cuenta que el objeto **AzureCliCredential** permitirá que el código se autentique en su cuenta de Azure. El objeto **AzureAIAgentClient de** incluirá automáticamente la configuración del proyecto Foundry de la configuración del archivo .env.
